...
Also, in every city you can buy fuel, at a price of C[i] dollar / litre. You must compute the minimum amount of dollars spent with fuel to travel from A to B.
*/
